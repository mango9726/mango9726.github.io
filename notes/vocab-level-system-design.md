...
### New Files
- `web/vocab/assets/js/core/cefr-selector.js` — Level selection logic & UI

### Modified Files
- `web/vocab/assets/js/core/app.js` — Integrate filtered items, init CEFR system
- `web/vocab/assets/js/auth/auth.js` — Call CEFR init on login/logout
- `web/vocab/assets/js/core/cefr-levels.js` — Export helper functions
