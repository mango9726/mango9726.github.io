/* ============================================================
   ...
   - collocations:{ phrase, exEn, exTh, note }
...
const VOCAB_DAYS = {
  "1": {
    ...
    collocations: [
      { phrase: "make a decision", exEn: "We need to make a decision before the deadline.", exTh: "เราต้องตัดสินใจก่อนกำหนดเส้นตาย", note: "อย่าพูด \"do a decision\" — ต้องใช้ make เสมอ" },
      { phrase: "take a break", exEn: "Let's take a break and continue after lunch.", exTh: "มาพักเบรกแล้วค่อยทำต่อหลังอาหารเที่ยงสิ", note: "ไม่ใช้ \"make a break\" — ใช้ take a break" },
      { phrase: "pay attention", exEn: "Please pay attention to the instructions.", exTh: "โปรดตั้งใจฟังคำแนะนำ", note: "อย่าใช้ \"listen attention\" — ถ้าจะใช้ listen ต้องเป็น listen to ส่วน pay attention ใช้คู่กับ pay attention to" },
      { phrase: "keep a promise", exEn: "He always keeps a promise he makes to his friends.", exTh: "เขามักจะรักษาคำสัญญาที่ให้ไว้กับเพื่อนเสมอ", note: "ไม่ใช้ \"hold a promise\" หรือ \"maintain a promise\" — ใช้ keep" },
      { phrase: "get along with", exEn: "Do you get along with your new roommate?", exTh: "คุณเข้ากับเพื่อนร่วมห้องใหม่ได้ดีไหม", note: "ต้องตามด้วย with (get along with somebody) — อย่าใช้ \"get along of\"" }
    ],
    idiom: {
  ...
  "2": {
    ...
    collocations: [
      { phrase: "make progress", exEn: "You've made great progress with your English.", exTh: "คุณทำความก้าวหน้าเรื่องภาษาอังกฤษได้มากเลย", note: "อย่าใช้ \"do progress\" — ต้องใช้ make progress เสมอ" },
      { phrase: "take responsibility", exEn: "It's time to take responsibility for your mistakes.", exTh: "ถึงเวลาที่คุณต้องรับผิดชอบต่อความผิดพลาดของตัวเอง", note: "ไม่ใช้ \"make responsibility\" — ใช้ take responsibility" },
      { phrase: "get rid of", exEn: "I want to get rid of these old clothes.", exTh: "ฉันอยากกำจัดเสื้อผ้าเก่าเหล่านี้ทิ้งไป", note: "แปลว่า \"กำจัด / ทิ้งไป\" — อย่าแปลทีละพยางค์ว่า get = ได้, rid = หลุด" },
      { phrase: "keep in touch", exEn: "Let's keep in touch after you move abroad.", exTh: "มาติดต่อกันเรื่อยๆ นะหลังจากคุณย้ายไปต่างประเทศ", note: "ไม่ใช้ \"stay in touch with\" ผิด แต่ stay in touch ก็ใช้ได้ — ต่างจาก keep on touch ที่ผิด" },
      { phrase: "pay a visit", exEn: "We should pay a visit to our grandparents this weekend.", exTh: "เราควรแวะไปเยี่ยมย่าตายายในสุดสัปดาห์นี้", note: "อย่าใช้ \"make a visit\" — ใช้ pay a visit" }
    ],
    idiom: {
